      ...
      builder: (_) => AlertDialog(
        ...
        content: const SingleChildScrollView(
          child: Text(
            ...
            "• Tap 'Analyze text'.\n"
            "• Our AI model evaluates the content and estimates how harmful it is.\n\n"
            "Result meanings:\n"
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  icon: _loading
                      ...
                      : const Icon(Icons.search),
                  label: Text(
                    _loading ? "Analyzing..." : "Analyze text",
                    style: const TextStyle(fontSize: 16),
                  ),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: AppColors.primary,
...
class _AnalyzeTextScreenState extends State<AnalyzeTextScreen> {
  ...
  Future<void> _reportToCyberCell() async {
    final user = FirebaseAuth.instance.currentUser;
    if (user == null) return;

    final String email = "cybercell@keralapolice.gov.in";
    //final String email = "m.nimisha010@gmail.com";
    final String subject = "Cyberbullying Complaint Report";
    final String body = """
Respected Cyber Cell Team,

I would like to report the following harmful content.

Type: Cyberbullying
Confidence: ${(_harmScore! * 100).toStringAsFixed(1)}%
...
""";
    ...
    // 🔥 SAVE REPORT TO FIRESTORE FIRST
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  icon: _loading
                      ...
                      : const Icon(
                          Icons.search,
                          color: Colors.white, // 👈 makes search icon white
                        ),
                  label: Text(
                    _loading ? "Analyzing..." : "Analyze text",
